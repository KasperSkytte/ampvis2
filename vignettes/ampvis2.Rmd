...
Notice that the plot can be saved as a more detailed object (`output = "detailed"`), so additional details about the ordination result can be obtained for evaluation, fx a screeplot by `ordinationresult$screeplot` or some more raw data by `ordinationresult$model`. 
