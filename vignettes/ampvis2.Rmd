...
First, import your data into R dataframes using an appropriate read function:
...
With the ampvis2 package comes a large example data set with 573 samples taken from the activated sludge from 55 Danish Wastewater Treatment Plants in the period 2006-2013, which can be loaded with `data("MiDAS")`. 
```{r, warning = FALSE}
data("MiDAS")
MiDAS
```
...
# Other functions
There are numerous other functions to try out. Go explore them under the [References](../reference/index.html) tab. 
